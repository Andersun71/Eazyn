            ...
            <div class="row">
              <div class="col-lg-12">
               ...
               <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">izin Digunakan</h5>                    
                    <div class="row align-items-center">
                      <div class="col-4">
                        <?php
                          $fetch_data2 = mysqli_fetch_all($run_sql2, MYSQLI_ASSOC);
                          $fetch_data3 = mysqli_fetch_all($run_sql3, MYSQLI_BOTH);
                          #$x = $fetch_data3[0][value];
                          #$y = $fetch_data2[0]['izin_digunakan']
                          #var_dump($fetch_data2[0]['izin_digunakan']);
                         #echo $fetch_data3[0]['value']-$fetch_data2[0]['izin_digunakan'];
                            #foreach($fetch_data2 as $data2){
                            ?>
                         <h1 class="fw-semibold mb-3"><?php echo $fetch_data3[0]['value']-$fetch_data2[0]['izin_digunakan']?></h1>
